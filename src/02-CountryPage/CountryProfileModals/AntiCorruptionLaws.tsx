        ...
        <>
          {!isMobile && (
            <div className='flex border-b-[#000] pb-2 border-b'>
              <ParagraphText weight='semibold' size='sm' marginBottom='none' className='text-[var(--color-text-black)] w-[40%]'>
                Name
              </ParagraphText>
              <ParagraphText weight='semibold' size='sm' marginBottom='none' className='text-[var(--color-text-black)] w-[25%] pr-4'>
                Category
              </ParagraphText>
              <ParagraphText weight='semibold' size='sm' marginBottom='none' className='text-[var(--color-text-black)] w-[10%]'>
                Year
              </ParagraphText>
              <ParagraphText weight='semibold' size='sm' marginBottom='none' className='text-[var(--color-text-black)] w-[15%]'>
                Revision years
              </ParagraphText>
              <ParagraphText weight='semibold' size='sm' marginBottom='none' className='text-[var(--color-text-black)] w-[10%]'>
                Link
            ...
            isMobile ? (
              <div className='py-3 border-b border-b-[#0000004D]' key={i}>
                ...
                <div className='flex items-center gap-2 mt-2 flex-wrap'>
                  <ParagraphText weight='regular' size='xs' marginBottom='none' className='text-[#4B6E91] p-1 px-2 border-[#4B6E9180] rounded-[4px] bg-[#4B6E911A] border w-fit'>
                    {d.Category}
                  </ParagraphText>
              ...
              <div className='flex border-b-[#0000004D] py-3 border-b' key={i}>
                <ParagraphText weight='regular' size='sm' marginBottom='none' className='text-[var(--color-text-black)] w-[40%] pr-4'>
                  {d.Law}
                </ParagraphText>
                <div className='w-[25%]'>
                  <ParagraphText weight='regular' size='xs' marginBottom='none' className='text-[#4B6E91] p-1 px-2 border-[#4B6E9180] rounded-[4px] bg-[#4B6E911A] border w-fit'>
                ...
                <ParagraphText weight='regular' size='sm' marginBottom='none' className='text-[var(--color-text-black)] w-[10%]'>
                  {d.Year || '-'}
                </ParagraphText>
                <ParagraphText weight='regular' size='sm' marginBottom='none' className='text-[var(--color-text-black)] w-[15%]'>
                  {d['Revision Year'] || '-'}
                </ParagraphText>
